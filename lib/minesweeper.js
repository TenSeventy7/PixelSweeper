...
class Cell {
    ...
    getAdjCells() {
        ...
        if (this.row > 0 && this.col > 0) adj.push(lvlBoard[this.row - 1][this.col - 1]);
        if (this.row > 0) adj.push(lvlBoard[this.row - 1][this.col]);
        if (this.row > 0 && this.col < lastCol) adj.push(lvlBoard[this.row - 1][this.col + 1]);
        if (this.col < lastCol) adj.push(lvlBoard[this.row][this.col + 1]);
        if (this.row < lastRow && this.col < lastCol) adj.push(lvlBoard[this.row + 1][this.col + 1]);
        if (this.row < lastRow) adj.push(lvlBoard[this.row + 1][this.col]);
        if (this.row < lastRow && this.col > 0) adj.push(lvlBoard[this.row + 1][this.col - 1]);
        if (this.col > 0) adj.push(lvlBoard[this.row][this.col - 1]);
        return adj;
    }
